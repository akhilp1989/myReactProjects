...
exports.default = [_extends({
  ...
  exact: true
}), _extends({ path: "/users" }, _UsersListPage2.default)];
...
app.get("*", function (req, res) {
  ...
  var route = (0, _reactRouterConfig.matchRoutes)(_Routes2.default, req.path);
  if (route.length) {
    var promises = route.map(function (_ref) {
      var route = _ref.route;

      return route.loadData ? route.loadData(store) : null;
    });
    Promise.all(promises).then(function (resp) {
      res.send((0, _renderhelper2.default)(req, store));
    });
  }
});
...
exports.default = function (req, store) {
  ...
  return "\n        <html>\n            <head></head>\n            <body>\n                <div id=\"root\">" + content + "</div>\n                <script>window.INITIAL_DATA = " + (0, _serializeJavascript2.default)(store.getState()) + "</script>\n                <script src=\"bundle.js\"></script>\n               \n              \n            </body>\n        </html>\n    ";
};
